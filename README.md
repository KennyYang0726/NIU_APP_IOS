...
這是一個給宜大學生使用的 iOS app，整合了大部分常使用到的功能，包含數位學習 M 園區、分數查詢、課表、活動報名、畢業門檻查詢、選課、請假、校園信箱，並提供公車動態查詢。
...
( 26 已修復此問題，並且這似乎是官方 Bug )
2. AppBar 在失去焦點時(跳出Alert)，會呈現灰色，而不是原先的深藍色 ( 這似乎也是官方 Bug )